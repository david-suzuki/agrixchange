...
const ProduceModal = (props) => {
    ...
    const onCategoryClicked = (category_id) => {
        onToggle(!isShow)
        router.push(`/produce/${category_id}`)
    }
    ...
    return (
        ...
        >
            ...
            <ModalBody className="px-2 pt-2 show-grid custom-grid">
                <h4 className="text-center mt-3">Choose a Produce Category Below</h4>
                        ...
                        <Row>
                        {
                            categories.map(category =>
                                <Col sm="6" md="6" className="produce-list-block mb-3" key={category._id}>
                                    <a onClick={()=>onCategoryClicked(category.numeric_id)}>
                                                ...
                                                <Media alt={category.name} >
                                                    <div 
                                                        style={{ 
                                                            ...
                                                            backgroundImage: `url(${encodeURI(`${contentsUrl + category.main_produce_image01ISfile}`)})`, 
