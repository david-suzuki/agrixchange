...
const MyAdvert = ({advertsPositions, advertsForSeller}) => {
    ...
    const onEdit = (advert) => {
        ...
        setSelectedPosition(advertsPositions.find(position=>position.numeric_id === advert.positionISbb_agrix_adverts_positionsID))
        setShowAdvertModal(!showAdvertModal)
    }
                ...
                <Row>
                {
                    ...
                    <Col sm="12">
                        <Card>
                            ...
                            <CardBody>
                                <MyAdverts 
                                    advertsForSeller={advertsForSeller}
                                    advertsPositions={advertsPositions}
                                    onEdit={onEdit}
                                />
                            </CardBody>
                        </Card>
