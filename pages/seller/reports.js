                ...
                <Row>
                    {
                        ...
                        <Col sm="12">
                            <NoData description="You have not added a report yet, lets get started!" createLabel="Create New Report" onCreate={handleCreate} />
                        </Col>:
                        <Col sm="12">
                            <Card>
                                <CardHeader>
                                    ...
                                    <div className="pull-right">
                                        <button onClick={handleCreate} className="btn btn-solid btn-default-plan btn-post">
                                            <i className="fa fa-plus-circle" aria-hidden="true"></i>Add New Report
                                        </button>
                                    </div>
