...
const BuyerPdf = ({ sellers, usersFavourites }) => {
  ...
  const buyerFollowingSellers = usersFavourites.filter(
      ...
      <Document>
        <Page style={styles.body} wrap size="A4">
          <View style={styles.header}>
            <View>
              <Text style={styles.title}>Buyer Following Table</Text>
            </View>
          </View>
                    ...
                    content: `${
                      produce_types.find(
                        (pt) =>
                          pt.numeric_id ===
                          favouriteData
                            .fav_produceISbb_agrix_users_produceID_data
                    ...
                    content: `${
                      produce_sizes.find(
                        (ps) =>
                          ...
                          favouriteData
                            .fav_produceISbb_agrix_users_produceID_data
                            .sizeISbb_agrix_produce_sizesID
                      )?.name
                    }`,
                    width: "20%",
                    textAlign: "center",
          ...
          <View style={styles.info}>
            <Text style={styles.subtitle}>Seller this buyer is following</Text>
          </View>
          <View style={styles.table}>
            {[
              {
