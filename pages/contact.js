    ...
    return (
        <CommonLayout title="collection" parent="home" sidebar={false}>
            <Banner 
              banner={banner}
            />
            <section className="section-b-space contact-section">
                <Container>
                    <h4 className="section-title mb-3">Contact Us</h4>
                          ...
                          <div className="col-lg-8 mt-5 mt-lg-0 d-flex">
                              <FormGroup className="email-form">
                                ...
                                <div className="text-center">
                                    <button type="submit" className="btn btn-solid btn-post">Send Message</button>
                                </div>
                              </FormGroup>
