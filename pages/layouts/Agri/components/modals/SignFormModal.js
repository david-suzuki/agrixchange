        ...
        <Modal
            ...
            <ModalBody className="p-3 show-grid">
              <form onSubmit={handleSubmit(onSignin)}>
                ...
                <Col className="mb-3 d-flex justify-content-between align-items-center">
                  ...
                  <a className="nav-link-style fs-ms signLink" onClick={() => handleToggle("forgot")}>Forgot password?</a>
                </Col>
                ...
                <Col className="mb-5">
                  Don't have an account? <a className="signLink" onClick={() => handleToggle("signup")}>Sign up</a>
                </Col>
              </form>
            </ModalBody>
          </div>
          ...
          <div className={form == "forgot" ? "show" : "hide"}>
            ...
            <ModalBody className="p-3 show-grid">
              ...
              <Col className="mb-3">
                <a onClick={() => handleToggle('signin')} href={null} className="link_back signLink">
                  <i
