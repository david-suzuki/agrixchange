...
const MasterCollection = ({ img, title, validity, location, price, type, size, packaging, farming, season, link, followStatus }) => {
  return (
    ...
    <div className="col-md-4 mb-3">
        ...
        <div className="ourseller-info produce-info">
                ...
                <Row>
                    <Col md="12">
                        <div className="pull-left">
                            <h5>Price: {price} &nbsp; <Lock color="#000000" /></h5>
                            <h5>Validity: {location}</h5>
                            <h5>{location}</h5>
                        </div>
                        <div className="pull-right">
                          <a className="linkCursor text-center">
                            <div><i className={followStatus == "Follow" ? "fa fa-star follow" : "fa fa-star unfollow"}></i></div>
            ...
            <div className="produce-info">
                <ul>
                    <li><a className="linkCursor"><i className='fa fa-bar-chart'></i></a></li>
                    <li><a className="linkCursor"><i className='fa fa-list-alt'></i></a></li>
                </ul>
            </div>
        </div>
    </div>
